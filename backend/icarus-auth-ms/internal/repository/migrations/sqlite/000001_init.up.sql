...
INSERT OR IGNORE INTO modules (id, code, name, base_url, is_active) VALUES
    ('icarus-auth-ms', 'icarus-auth-ms', 'Auth Service', 'http://localhost:8080', 1),
    ('icarus-admin-ms', 'icarus-admin-ms', 'Platform Service', 'http://localhost:8081', 1);

-- Seed permissions for icarus-auth-ms
INSERT OR IGNORE INTO permissions (id, module_id, action, description) VALUES
...
INSERT OR IGNORE INTO roles (id, module_id, tenant_id, name, description, is_system_role, type) VALUES
    ('icarus-auth-ms:admin', 'icarus-auth-ms', NULL, 'admin', 'Administrator with full access', 1, 'Custom');
